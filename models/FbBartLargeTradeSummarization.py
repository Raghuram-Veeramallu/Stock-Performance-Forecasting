...
class FbBartLargeTradeSummarization(HuggingFaceSummarizationBaseModel):

    def __init__(self) -> None:
        self.model_id = 'nickmuchi/fb-bart-large-finetuned-trade-the-event-finance-summarizer'
